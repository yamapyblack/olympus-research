//https://etherscan.io/address/0x383518188c0c6d7730d91b2c03a03c837814a899#code
...
interface ITWAPOracle {
    function uniV2CompPairAddressForLastEpochUpdateBlockTimstamp(
        address
...
contract TWAPOracleUpdater is ERC20Permit, VaultOwned {
    ...
    event TWAPEpochChanged(
        uint previousTWAPEpochPeriod,
        uint newTWAPEpochPeriod
    );
    ...
    function changeTWAPEpochPeriod(
        uint newTWAPEpochPeriod_
    ) external onlyOwner {
        require(
